...
class Interfaces
{
	...
	private:
		...
		template<class InterfaceT>	void	probe_interface(string id, string device)		throw();
		template<class InterfaceT>	void	probe_interface_0(string id)					throw();
		template<class InterfaceT>	void	probe_interface_1(string id, string device)		throw();
